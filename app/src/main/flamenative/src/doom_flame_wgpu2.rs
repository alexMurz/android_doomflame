...
impl crate::DoomFlameRunner for DoomFlame {
    fn create(resolution: usize, palette: Vec<u32>) -> Self {
        ...
        let color_stage = dev.create_buffer(&wgpu::BufferDescriptor {
            label: Some("color-stage"),
            size: temp_buffer_size as u64,
    ...
    fn update(&mut self) {
        ...
        encoder.copy_buffer_to_buffer(
            ...
            color_stage,
            0,
            (resolution * resolution * 4) as wgpu::BufferAddress,
        );
        ...
        {
            let buffer_to_map = color_stage;
            let buffer_slice = buffer_to_map.slice(..);
